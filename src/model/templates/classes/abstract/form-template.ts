...
export abstract class FormTemplate {
  ...
  public readonly adapters : ReadonlyArray<AbstractAdapter<string, FormElement | AbstractGroup<string, GroupMembers>, unknown>> = [];
  public readonly groups : ReadonlyArray<AbstractGroup<string, GroupMembers>> = [];
  public readonly derivedValues : ReadonlyArray<AbstractDerivedValue<string, unknown>> = [];
