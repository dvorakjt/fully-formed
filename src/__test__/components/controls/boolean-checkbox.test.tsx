...
import { BooleanCheckbox } from '../../../components';
...
describe('BooleanCheckbox', () => {
  ...
  of the input it renders is updated.`, async () => {
    ...
    form.formElements.testCheckbox.setValue(true);
  ...
  updated.`, async () => {
    ...
    await user.click(input);
    expect(form.formElements.testCheckbox.state.value).toBe(true);

    await user.click(input);
    expect(form.formElements.testCheckbox.state.value).toBe(false);
  });
