...
import { Field, Adapter, StringValidators, Validity } from '../../../model';

describe('Adapter', () => {
  test(`Its value is initialized to the result of calling its adapt function 
  with the state of its source.`, () => {
